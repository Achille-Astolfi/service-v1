...
export class DataEntryComponent implements OnInit {
  ...
  //per usare un service occorre dichiararlo come paramentro del constructor
  //si deve aggiungere una parola ciave a scelta tra private, public o protected
  //questa sintassi di TS dichiara automaticamente una property di nome
  //personService
  constructor(
